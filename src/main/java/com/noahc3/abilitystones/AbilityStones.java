...
@Mod(modid = AbilityStones.modID, name = AbilityStones.name, version = AbilityStones.version, acceptedMinecraftVersions = "[1.11.2]")
public class AbilityStones {

    public static final String modID = "abilstones";
    public static final String name = "Ability Stones";
    public static final String version = "11.2.0.0 beta 3";
